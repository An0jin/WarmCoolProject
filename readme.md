...
| 이름   | 역할  | 이유  |
| -------- | ------------ |  ------------ | 
| 안영진 (👨‍💻,🎨) |     데이터 라벨링 및 이미지 분류 모델, 백앤드, AR 프론트앤드 개발 및 UI/UX 디자인     |     과외 수업자료로 쓰기 좋아서     |
| 정현중 (📜)  | 문서관리 및 제작 |     교수님이 인정할 정도로 문서를 잘 만들어서     |
| Tharaphy Hnin(📊) | 데이터 수집 및 유저 데이터 분석 |     여자라 화장 데이터를 잘 다룰것같아서     |
